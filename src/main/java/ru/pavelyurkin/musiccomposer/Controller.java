...
import ru.pavelyurkin.musiccomposer.composer.ComposeBlockProvider;
import ru.pavelyurkin.musiccomposer.composer.CompositionComposer;
import ru.pavelyurkin.musiccomposer.composer.next.FormNextBlockProvider;
import ru.pavelyurkin.musiccomposer.composer.next.filter.ComposeBlockFilter;
import ru.pavelyurkin.musiccomposer.composer.next.filter.custom.BachChoralFilter;

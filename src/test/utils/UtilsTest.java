...
import static utils.Utils.getClosestListElement;
import static utils.Utils.rhythmValues;
import static utils.Utils.roundRhythmValue;
...
public class UtilsTest {
	...
	public void closestListElementTest() {
		...
		assertEquals( getClosestListElement( 0.7, rhythmValues ), QUARTER_NOTE_TRIPLET );
		...
		assertEquals( getClosestListElement( 0.3, rhythmValues ), EIGHTH_NOTE_TRIPLET );
		assertEquals( getClosestListElement( 0.3, rhythmValues ), EIGHTH_NOTE_TRIPLET );

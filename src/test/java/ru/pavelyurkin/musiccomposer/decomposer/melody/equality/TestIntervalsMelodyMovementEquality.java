...
import ru.pavelyurkin.musiccomposer.equality.melodymovement.IntervalsMelodyMovementEquality;
...
public class TestIntervalsMelodyMovementEquality {
	...
	public void getEqualityMetricTest() {
		...
		assertTrue( intervalsMelodyMovementEquality.getEqualityMetric( melodyMovement20, melodyMovement21 ) > intervalsMelodyMovementEquality
		...
		assertTrue( intervalsMelodyMovementEquality.getEqualityMetric( melodyMovement30, melodyMovement31 ) == intervalsMelodyMovementEquality

package ru.pavelyurkin.musiccomposer.persistance.model;
...
import ru.pavelyurkin.musiccomposer.persistance.jpa.Melody;
import ru.pavelyurkin.musiccomposer.persistance.jpa.Note;
...
public class PersistConverterTest extends AbstractSpringTest {
	...
	public void convert() {
		...
		ru.pavelyurkin.musiccomposer.model.Lexicon lexicon = getDefaultLexicon();
	...
	private ru.pavelyurkin.musiccomposer.model.Lexicon getDefaultLexicon() {
		List<ru.pavelyurkin.musiccomposer.model.melody.Melody> melodyList1 = new ArrayList<>();
		ru.pavelyurkin.musiccomposer.model.MusicBlock musicBlock0 = new ru.pavelyurkin.musiccomposer.model.MusicBlock( null,
				new ru.pavelyurkin.musiccomposer.model.melody.Melody(
						'A',
		...
		ru.pavelyurkin.musiccomposer.model.MusicBlock musicBlock1 = new ru.pavelyurkin.musiccomposer.model.MusicBlock( null,
				new ru.pavelyurkin.musiccomposer.model.melody.Melody(
						'C',
		...
		ru.pavelyurkin.musiccomposer.model.MusicBlock musicBlock2 = new ru.pavelyurkin.musiccomposer.model.MusicBlock( null,
				new ru.pavelyurkin.musiccomposer.model.melody.Melody(
						'A',
		...
		ru.pavelyurkin.musiccomposer.model.MusicBlock musicBlock3 = new ru.pavelyurkin.musiccomposer.model.MusicBlock( null,
				new ru.pavelyurkin.musiccomposer.model.melody.Melody(
						'C',
		...
		ru.pavelyurkin.musiccomposer.model.MusicBlock musicBlock4 = new ru.pavelyurkin.musiccomposer.model.MusicBlock( null,
				new ru.pavelyurkin.musiccomposer.model.melody.Melody(
						'A',
		...
		ru.pavelyurkin.musiccomposer.model.ComposeBlock composeBlock0 = new ru.pavelyurkin.musiccomposer.model.ComposeBlock( musicBlock0 );
		ru.pavelyurkin.musiccomposer.model.ComposeBlock composeBlock1 = new ru.pavelyurkin.musiccomposer.model.ComposeBlock( musicBlock1 );
		ru.pavelyurkin.musiccomposer.model.ComposeBlock composeBlock2 = new ru.pavelyurkin.musiccomposer.model.ComposeBlock( musicBlock2 );
		ru.pavelyurkin.musiccomposer.model.ComposeBlock composeBlock3 = new ru.pavelyurkin.musiccomposer.model.ComposeBlock( musicBlock3 );
		ru.pavelyurkin.musiccomposer.model.ComposeBlock composeBlock4 = new ru.pavelyurkin.musiccomposer.model.ComposeBlock( musicBlock4 );
		...
		List<ru.pavelyurkin.musiccomposer.model.ComposeBlock> composeBlockList = new ArrayList<>();
		composeBlockList.add( composeBlock0 );
		composeBlockList.add( composeBlock1 );
		composeBlockList.add( composeBlock2 );
		composeBlockList.add( composeBlock3 );
		...
		ru.pavelyurkin.musiccomposer.model.Lexicon persistanceLexicon = new ru.pavelyurkin.musiccomposer.model.Lexicon( composeBlockList, nextMap );
	...
	public void wrongFormTest() {
		...
		ru.pavelyurkin.musiccomposer.model.ComposeBlock modelComposeBlock = new ru.pavelyurkin.musiccomposer.model.ComposeBlock( 0, null, Arrays.asList( new ru.pavelyurkin.musiccomposer.model.melody.Melody( 'B', new jm.music.data.Note( C3, HALF_NOTE_TRIPLET, 0, 0 ) ) ) ,null );
		...
		ru.pavelyurkin.musiccomposer.model.ComposeBlock convertedFromPersist = persistConverter.convertComposeBlock( composeBlock );

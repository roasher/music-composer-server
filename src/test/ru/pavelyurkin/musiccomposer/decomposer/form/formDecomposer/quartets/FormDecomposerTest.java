package ru.pavelyurkin.musiccomposer.decomposer.form.formDecomposer.quartets;
...
public class FormDecomposerTest extends AbstractSpringTest {
	...
	public void quartetScarecrowIntro() {
		Composition composition = compositionLoader.getComposition( new File( "src/test/ru/pavelyurkin/musiccomposer/decomposer/form/formDecomposer/quartets/2.Scarecrow's song (midi).mid" ) );

...
public class RhythmEqualityPatternTest {
  ...
  public boolean isEqual(List<List<Double>> firstRhythmPattern, List<List<Double>> secondRhythmPattern) {
    ...
    for (int currentInstrument = 0; currentInstrument < firstRhythmPattern.size(); currentInstrument++) {
      if (isCountsOfRhythmEntriesEquals(firstRhythmPattern.get(currentInstrument),
          secondRhythmPattern.get(currentInstrument))) {
        numberOfEqualParts++;
      }
    }
  ...
  public boolean isCountsOfRhythmEntriesEquals(List<Double> firstSingleVoiceRhythmPattern,
                                               List<Double> secontSingleVoiceRhythmPattern) {

...
public class MelodyMovement {
  ...
  /**
   * Returns new MelodyMovement represents MelodyMovement with swapped notes that belongs to the
   * numberOfInterval-nth interval
   ...
   * @return new MelodyMovement object that is copy of the creator one, but 3 intervals ( numberOfInterval -1;
  ...
  public boolean equals(Object inputObject) {
    if (inputObject instanceof MelodyMovement) {
      ...
      if (inputMelodyMovement.getPitchIntervals().size() == this.getPitchIntervals().size()) {
        for (int intervalNumber = 0; intervalNumber < inputMelodyMovement.getPitchIntervals().size();
             intervalNumber++) {
          if (!inputMelodyMovement.getPitchIntervals().get(intervalNumber)
              .equals(this.getPitchIntervals().get(intervalNumber))) {
            return false;
          }
        }
        return true;

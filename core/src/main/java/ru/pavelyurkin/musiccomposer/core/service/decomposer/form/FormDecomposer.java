...
public class FormDecomposer {
  ...
  public List<List<InstrumentPart>> decompose(Composition composition, double rhythmValue) {
    ...
    //			// Comparing current music block with all previous music blocks searching for ru.pavelyurkin
    //			.musiccomposer
    ...
    //						} else {
    //							// if we found local maximum - it means that we have tested ru.pavelyurkin
    //							.musiccomposer

package ru.pavelyurkin.musiccomposer.core.service.decomposer.form;

import java.util.ArrayList;
import java.util.List;
import lombok.RequiredArgsConstructor;
import ru.pavelyurkin.musiccomposer.core.service.equality.form.MelodyFormEqualityAnalyzer;
...
//			// Comparing current music block with all previous music blocks searching for ru.pavelyurkin.musiccomposer
//			.equality - setting value if ru.pavelyurkin.musiccomposer.equality occurs and highest value + 1 if not
//			for ( int melodyBlockToCompareWithNumber = 0;
//				  melodyBlockToCompareWithNumber < melodyBlockNumber; melodyBlockToCompareWithNumber++ ) {
//				List<InstrumentPart> melodyBlockToCompareWith = instrumentPartsCollection.get(
//				melodyBlockToCompareWithNumber );
...
//						} else {
//							// if we found local maximum - it means that we have tested ru.pavelyurkin.musiccomposer
//							.equality for all of the chars include max
